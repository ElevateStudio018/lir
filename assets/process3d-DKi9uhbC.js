...
void main() {
	...
	`}var ec=class extends Bt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ei(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      void main() {
        ...
        #include <colorspace_fragment>
      }`}),D=new Z(new io(420,32,16),E);f.add(D);let O=new ga;O.moveTo(-300,-300).lineTo(300,-300).lineTo(300,300).lineTo(-300,300).lineTo(-300,-300);let k=new ha;k.moveTo(-14,-9).lineTo(-14,9).lineTo(14,9).lineTo(14,-9).lineTo(-14,-9),O.holes.push(k);let A=new Z(new no(O),C.ground);A.rotation.x=-Math.PI/2,A.receiveShadow=!0,w.add(A);let j=new Z(new ji(28,3,18),C.soil);j.position.y=-3/2-.001,j.receiveShadow=!0,w.add(j);let ee=new Z(new to(28,18),C.lid);ee.rotation.x=-Math.PI/2,ee.position.y=.002,ee.receiveShadow=!0,w.add(ee);let M=new mo({transparent:!0,depthWrite:!1,uniforms:{uOpacity:{value:0},uColor:{value:new X(9419478)},uReveal:{value:0}},vertexShader:`
      varying vec2 vXZ;
      void main() {
      ...
      void main() {
        ...
        #include <colorspace_fragment>
      }`}),te=new Z(new to(240,240),M);te.rotation.x=-Math.PI/2,te.position.y=.02,te.renderOrder=2,w.add(te);let N=[],ne=(e,t)=>N.push(e[0],.04,e[1],t[0],.04,t[1]),re=(e,t=!0)=>{for(let n=0;n<e.length-+!t;n++)ne(e[n],e[(n+1)%e.length])};re([[-38,-30],[34,-34],[42,18],[8,30],[-40,26]]);for(let e=0;e<4;e++){let t=[];for(let n=0;n<=40;n++){let r=-70+n*3.5;t.push([r,-46-e*7+Math.sin(r*.06+e)*4+Math.cos(r*.021)*3])}re(t,!1)}for(let e=0;e<=Ku;e++)ne([Qu+e*Ju,-12.75],[Qu+e*Ju,12.75]);for(let e=0;e<=qu;e++)ne([-18,$u+e*Yu],[18,$u+e*Yu]);re([[Qu,$u],[12,$u],[12,6.75],[Qu,6.75]]),re([[-12.4,-7.15],[12.4,-7.15],[12.4,7.15],[-12.4,7.15]]);let ie=15.75;ne([Qu,ie],[12,ie]);for(let e=0;e<=Ku;e++)ne([Qu+e*Ju-.5,16.25],[Qu+e*Ju+.5,15.25]);ne([-21,$u],[-21,6.75]);for(let e=0;e<=qu;e++)ne([-21.5,$u+e*Yu+.5],[-20.5,$u+e*Yu-.5]);re([[-90,19],[90,19]],!1),re([[-90,27],[90,27]],!1),re([[-4,19],[-4,7.15]],!1),re([[4,19],[4,7.15]],!1);let ae=(e,t,n)=>{let r=[];for(let i=0;i<20;i++)r.push([e+Math.cos(i/20*Math.PI*2)*n,t+Math.sin(i/20*Math.PI*2)*n]);re(r)};for(let e=0;e<=Ku;e++)ae(Qu+e*Ju,-13.95,1.1);for(let e=0;e<=qu;e++)ae(-19.2,$u+e*Yu,1.1);re([[30,-22],[32,-16],[34,-22],[32,-20.5]]);let oe=new br;oe.setAttribute(`position`,new cr(N,3));let P=N.length/3,se=new oi({color:11916520,transparent:!0,opacity:0,depthWrite:!1,fog:!1}),ce=new vi(oe,se);ce.renderOrder=3,ce.frustumCulled=!1,w.add(ce);let F=new _n,I=[],le=new zi(new ji(Xu,Gu,Zu)).attributes.position.array;for(let e=0;e<Wu;e++)for(let t=0;t<le.length;t+=3)I.push(le[t],le[t+1]+Gu/2+e*Gu,le[t+2]);for(let e=0;e<=Ku;e++)for(let t=0;t<=qu;t++)I.push(Qu+e*Ju,0,$u+t*Yu,Qu+e*Ju,Wu*Gu,$u+t*Yu);for(let e=1;e<=Wu;e++)for(let t=1;t<Ku;t++)I.push(Qu+t*Ju,e*Gu,$u,Qu+t*Ju,e*Gu,6.75);let ue=10.75;I.push(16,0,ue,16,Wu*Gu,ue);for(let e=0;e<=Wu;e++)I.push(15.4,e*Gu,ue,16.6,e*Gu,ue);let de=new br;de.setAttribute(`position`,new cr(I,3));let fe=new oi({color:11916520,transparent:!0,opacity:0,depthWrite:!1,fog:!1}),pe=new vi(de,fe);pe.renderOrder=3,F.add(pe);let me=new Mr({color:9419478,transparent:!0,opacity:0,depthWrite:!1,side:2,fog:!1}),he=new Z(new to(27,16.5),me);he.rotation.x=-Math.PI/2,he.renderOrder=4,F.add(he);let ge=new vi(new zi(new to(27,16.5)),fe);ge.rotation.x=-Math.PI/2,F.add(ge),w.add(F);let _e=[];for(let e=0;e<=Ku;e++)for(let t=0;t<=qu;t++)_e.push([Qu+e*Ju,$u+t*Yu]);let ve=_e.length,ye=new ti(new ji(1.8,2.6,1.8),C.concrete,ve);ye.castShadow=ye.receiveShadow=!0,w.add(ye);let be=new Z(new ji(25,.5,14.5),C.slab);be.castShadow=be.receiveShadow=!0,be.userData.edges=!0,w.add(be),T.push(be);let xe=s?160:380,Se=new br,Ce=new Float32Array(xe*3),we=new Float32Array(xe*3);{let e=nd(7);for(let t=0;t<xe;t++)Ce[t*3]=(e()-.5)*40,Ce[t*3+1]=e()*8,Ce[t*3+2]=(e()-.5)*30}Se.setAttribute(`position`,new ar(we,3));let Te=new yi({size:.35,map:id(),color:14272942,transparent:!0,opacity:0,depthWrite:!1,sizeAttenuation:!0}),Ee=new wi(Se,Te);Ee.frustumCulled=!1,w.add(Ee);let De=ve*Wu,Oe=new ti(new ji(.42,1,.42),C.concrete,De);Oe.castShadow=Oe.receiveShadow=!0,w.add(Oe);let ke=[];for(let e=1;e<=Wu;e++){for(let t=0;t<=qu;t++)for(let n=0;n<Ku;n++)ke.push({f:e,dir:`x`,x:Qu+(n+.5)*Ju,z:$u+t*Yu,len:3.58,k:n+t*Ku});for(let t=0;t<=Ku;t++)for(let n=0;n<qu;n++)ke.push({f:e,dir:`z`,x:Qu+t*Ju,z:$u+(n+.5)*Yu,len:4.08,k:n+t*qu})}let Ae=new ti(new ji(1,.46,.3),C.steel,ke.length);Ae.castShadow=!0,w.add(Ae);let je=[];for(let e=1;e<=Wu;e++){let e=new Z(new ji(24.8,.32,14.3),C.slab);e.geometry.translate(24.8/2,0,0),e.castShadow=e.receiveShadow=!0,e.userData.edges=!0,w.add(e),je.push(e),T.push(e)}let L=19.6,Me=new Z(new ji(3.6,L,4.2),C.concrete);Me.geometry.translate(0,L/2,0),Me.position.set(6,0,0),Me.castShadow=Me.receiveShadow=!0,Me.userData.edges=!0,w.add(Me),T.push(Me);let R=new _n;R.position.copy(ed);{let e=[],n=1.7,r=(e,t,n)=>new K(e,t,n),i=[r(-1.7/2,0,-1.7/2),r(n/2,0,-1.7/2),r(n/2,0,n/2),r(-1.7/2,0,n/2)];for(let t of i)e.push(fd(t,r(t.x,td,t.z),.16));let a=2.2;for(let t=0;t<31.8;t+=a)for(let n=0;n<4;n++){let o=i[n],s=i[(n+1)%4];e.push(fd(r(o.x,t,o.z),r(s.x,t+a,s.z),.07)),e.push(fd(r(o.x,t+a,o.z),r(s.x,t+a,s.z),.07))}let o=new Z(Vu(e),C.crane);o.castShadow=!0,R.add(o);let s=new _n;s.position.y=td;let c=[],l=1.6;c.push(fd(r(-12,0,-.7),r(42,0,-.7),.14)),c.push(fd(r(-12,0,.7),r(42,0,.7),.14)),c.push(fd(r(-12,l,0),r(42,l*.4,0),.14));for(let e=-12;e<42;e+=2.4){let n=e<0?l:t(l,l*.4,e/42);c.push(fd(r(e,0,-.7),r(e+1.2,n,0),.06)),c.push(fd(r(e,0,.7),r(e+1.2,n,0),.06)),c.push(fd(r(e+1.2,n,0),r(e+2.4,0,-.7),.06)),c.push(fd(r(e+1.2,n,0),r(e+2.4,0,.7),.06))}c.push(fd(r(0,0,0),r(0,7,0),.3)),c.push(fd(r(0,7,0),r(26.04,l*.6,0),.05)),c.push(fd(r(0,7,0),r(-11.5,l,0),.05));let u=new Z(Vu(c),C.crane);u.castShadow=!0,s.add(u);let d=new Z(new ji(3.2,2.2,2.2),C.craneDark);d.position.set(-10,-.6,0),d.castShadow=!0,s.add(d);let f=new Z(new ji(2,2,1.8),C.craneDark);f.position.set(1.6,-1.2,1.5),s.add(f);let p=new _n,m=new Z(new Ni(.03,.03,1,4),C.craneDark);m.geometry.translate(0,-.5,0),p.add(m);let h=new _n,g=new Z(new ji(.6,.8,.4),C.crane);h.add(g);let _=new Z(new ji(5.2,.44,.3),C.steel);_.position.y=-1.6,_.castShadow=!0,h.add(_),p.add(h),s.add(p),R.userData={slew:s,trolley:p,cable:m,hook:h,load:_},R.add(s)}w.add(R);let Ne=[],z=0;for(let e=0;e<Wu;e++){for(let t=0;t<Ku;t++)Ne.push({f:e,x:Qu+(t+.5)*Ju,z:7.07,ry:0,w:Ju,n:[0,1],ord:z++});for(let t=0;t<qu;t++)Ne.push({f:e,x:12.32,z:6.75-(t+.5)*Yu,ry:Math.PI/2,w:Yu,n:[1,0],ord:z++});for(let t=0;t<Ku;t++)Ne.push({f:e,x:12-(t+.5)*Ju,z:-7.07,ry:Math.PI,w:Ju,n:[0,-1],ord:z++});for(let t=0;t<qu;t++)Ne.push({f:e,x:-12.32,z:$u+(t+.5)*Yu,ry:-Math.PI/2,w:Yu,n:[-1,0],ord:z++})}let Pe=Ne.length,B=Ne.filter(e=>e.f>0),V=new ti(new ji(1,1,.26),C.panel,B.length);V.castShadow=V.receiveShadow=!0,w.add(V);let Fe=nd(11),Ie=[],Le=[];for(let e of Ne)(Fe()<.62?Le:Ie).push(e);let Re=new ti(new ji(1,1,.08),C.glass,Ie.length),ze=new ti(new ji(1,1,.08),C.glassLit,Le.length);w.add(Re,ze);let Be=[];for(let e=0;e<=12;e++)Be.push({x:Qu+Ju/2*e,z:7.37,ry:0}),Be.push({x:Qu+Ju/2*e,z:-7.37,ry:0});for(let e=0;e<=6;e++)Be.push({x:12.62,z:$u+Yu/2*e,ry:Math.PI/2}),Be.push({x:-12.62,z:$u+Yu/2*e,ry:Math.PI/2});let Ve=new ti(new ji(.14,1,.56),C.wood,Be.length);Ve.castShadow=!0,w.add(Ve);let He=new _n,Ue=new Z(Vu([new ji(25.4,.9,.3).translate(0,0,7.3),new ji(25.4,.9,.3).translate(0,0,-13.5/2-.55),new ji(.3,.9,14.9).translate(12.55,0,0),new ji(.3,.9,14.9).translate(-12.55,0,0)]),C.panel);Ue.position.y=18.75,Ue.castShadow=!0,Ue.userData.edges=!0,He.add(Ue),T.push(Ue);let We=new Z(new ji(5,1.8,3.2),C.panel);We.position.set(6,19.2,0),We.castShadow=!0,We.userData.edges=!0,He.add(We),T.push(We);let Ge=new ti(new ji(2.6,.06,1.4),C.solar,18);for(let e=0;e<18;e++){let t=-9+e%6*2.9,n=-4+Math.floor(e/6)*2.6;dd(Ge,e,t,18.8,n,1,1,1,0,-.35)}Ge.castShadow=!0,He.add(Ge),w.add(He);let Ke=new Z(new to(44,30),C.plaza);Ke.rotation.x=-Math.PI/2,Ke.position.set(0,.03,2),Ke.receiveShadow=!0,w.add(Ke);let qe=new Z(new to(260,8),C.asphalt);qe.rotation.x=-Math.PI/2,qe.position.set(0,.04,23),qe.receiveShadow=!0,w.add(qe);let Je=new ti(new ji(3,.02,.18),C.marking,30);for(let e=0;e<30;e++)dd(Je,e,-120+e*8.2,.06,23,1,1,1);w.add(Je);let Xe=nd(3),Ze=[],Qe=s?26:54,$e=0;for(;Ze.length<Qe&&$e++<2e3;){let e=(Xe()-.5)*110,t=-44+Xe()*62;if(Math.abs(e)<23&&t>-17&&t<17.5||t>17.5&&t<29||Math.hypot(e-ed.x,t-ed.z)<4)continue;let n=.75+Xe()*.7;Ze.push({x:e,z:t,s:n,h:5+Xe()*4,birch:Xe()<.35,d:Math.hypot(e,t)})}for(let e=0;e<6;e++)Ze.push({x:-21+e*8.4,z:15.5,s:.8,h:6,birch:e%2==0,d:20+e});Ze.sort((e,t)=>e.d-t.d);let et=new ti(new Ni(.14,.22,1,6).translate(0,.5,0),C.trunk,Ze.length),tt=new ti((()=>{let e=Vu([[0,0,0,1],[.45,.35,.2,.7],[-.4,.25,-.25,.72],[.05,.62,-.1,.6]].map(([e,t,n,r],i)=>{let a=Uu(new eo(r,3).deleteAttribute(`normal`).deleteAttribute(`uv`)),o=a.attributes.position,s=new K;for(let r=0;r<o.count;r++){s.fromBufferAttribute(o,r);let a=1+.14*Math.sin(s.x*5.1+i)*Math.cos(s.y*4.3-i)+.08*Math.sin(s.z*7.7);s.multiplyScalar(a).add(new K(e,t,n)),o.setXYZ(r,s.x,s.y,s.z)}return a}));return e.computeVertexNormals(),e.scale(.82,.82,.82),e})(),C.crown,Ze.length);et.castShadow=tt.castShadow=!0,tt.receiveShadow=!0;let nt=new X(3950387),rt=new X(5595199),it=new X(7237960);Ze.forEach((e,t)=>{let n=e.birch?it.clone():nt.clone().lerp(rt,Xe());tt.setColorAt(t,n)}),w.add(et,tt);let at=[];for(let e=0;e<12;e++)at.push({x:-55+e*10,z:18.4});let ot=new ti(new Ni(.07,.09,5,5).translate(0,2.5,0),C.lamp,at.length),st=new ti(new ji(.9,.16,.3),C.lampHead,at.length);w.add(ot,st);let ct=s?16:34,H=[],U=new ti(new Mi(.22,1.15,3,6),C.people,ct);U.castShadow=!0;let lt=nd(21),ut=[2369836,4012083,5198935,6179387,2042422,7170143];for(let e=0;e<ct;e++){let t=lt()<.35;H.push({x:(lt()-.5)*40,z:t?17+lt()*1.2:8+lt()*7,v:(lt()<.5?-1:1)*(.5+lt()*.8)*(lt()<.25?0:1),s:.9+lt()*.15,d:lt()}),U.setColorAt(e,new X(ut[e%ut.length]))}w.add(U);let dt=new mo({transparent:!0,depthTest:!1,depthWrite:!1,uniforms:{uOpacity:{value:0},uColor:{value:new X(16053231)},uGrid:{value:new X(725267)},uGridAmt:{value:0},uRes:{value:new G(1,1)}},vertexShader:`void main(){ gl_Position = vec4(position.xy, 0.0, 1.0); }`,fragmentShader:`
      uniform float uOpacity; uniform vec3 uColor; uniform vec3 uGrid; uniform float uGridAmt; uniform vec2 uRes;
      void main(){
        ...
        vec3 col = mix(uColor, uGrid, (minor * 0.06 + major * 0.12) * uGridAmt);
        col *= mix(0.9, 1.0, vig);
        gl_FragColor = vec4(col, uOpacity);
        #include <colorspace_fragment>
      }`}),ft=new Z(new to(2,2),dt);ft.frustumCulled=!1,ft.renderOrder=998,f.add(ft);let pt=new mo({transparent:!0,depthWrite:!1,uniforms:{uOpacity:{value:0},uColor:{value:new X(1909799)},uSweep:{value:0},uRes:{value:new G(1,1)},uAccent:{value:new X(13133370)}},vertexShader:`void main(){ gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }`,fragmentShader:`
      uniform float uOpacity; uniform vec3 uColor; uniform float uSweep; uniform vec2 uRes; uniform vec3 uAccent;
      void main(){
        ...
        #include <colorspace_fragment>
      }`}),mt=null,ht=[{t:0,p:[52,46,60],l:[0,0,0]},{t:.1,p:[30,50,36],l:[0,0,1]},{t:.2,p:[-6,28,48],l:[0,5,0]},{t:.3,p:[-26,7.5,30],l:[0,-.5,0]},{t:.4,p:[-34,11,24],l:[0,3,0]},{t:.5,p:[-26,19,38],l:[0,7,0]},{t:.6,p:[12,17,54],l:[0,8.5,0]},{t:.7,p:[38,10,36],l:[0,8,0]},{t:.8,p:[50,17,60],l:[0,7,0]},{t:.865,p:[48,16.5,58],l:[0,7,0]},{t:.93,p:[47,16,57],l:[0,7,0]},{t:1,p:[7,8.5,12],l:[-2,7.6,-2]}],gt=new Yi(ht.map(e=>new K(...e.p)),!1,`centripetal`),W=new Yi(ht.map(e=>new K(...e.l)),!1,`centripetal`),_t=e=>{for(let t=0;t<ht.length-1;t++)if(e<=ht[t+1].t){let r=(e-ht[t].t)/(ht[t+1].t-ht[t].t);return(t+i.smooth(n(r))*.5+n(r)*.5)/(ht.length-1)}return 1},vt=[{p:[0,0,15.75],text:`24 000`,win:[.06,.28]},{p:[-21,0,0],text:`13 500`,win:[.07,.28]},{p:[34,0,-30],text:`Tomt <b>12 400 m²</b>`,win:[.05,.24]},{p:[Qu,0,$u],text:`±0.00 <b>RH2000 +14.2</b>`,win:[.08,.26]},{p:[16,Wu*Gu,10.75],text:`+18.00 <b>Vån 5</b>`,win:[.16,.27]},{p:[0,Wu*Gu*.5,6.75],text:`BIM <b>LOD 300</b>`,win:[.17,.26]},{p:[14,-3,9],text:`Schakt <b>−3.00</b>`,win:[.28,.4]},{p:[0,.3,7.25],text:`Platta <b>500 mm</b>`,win:[.33,.41]},{p:[Qu,Gu*2,6.75],text:`Pelare <b>400×400</b>`,win:[.45,.58]},{p:[12,Gu*3,0],text:`HSQ-balk <b>S355</b>`,win:[.49,.58]},{p:[12.5,Gu*3.2,7.35],text:`Fasad <b>Trä / glas</b>`,win:[.62,.72]},{p:[-9,19.1,-4],text:`Solceller <b>86 kWp</b>`,win:[.66,.72]}],yt=[],bt=new K,xt=1,St=1,Ct=0,q=0,wt=-1,Tt=0,Et=0,Dt={x:0,y:0,sx:0,sy:0},J=new K,Ot=new K,kt=new X(725267),At=new X(14201994),jt=new X,Mt=new X(1581091),Nt=new X(7304026),Pt=new X(10467536),Ft=new X(16763278);function It(o){let s=e(o,a.idea),c=e(o,a.plan),u=e(o,a.ground),d=e(o,a.frame),f=e(o,a.facade),m=e(o,a.result),v=e(o,a.blueprint),y=e(o,[0,.06]);M.uniforms.uReveal.value=i.out(n(y*.6+s*.8)),M.uniforms.uOpacity.value=(1-r(u,.5,1))*.9,oe.setDrawRange(0,Math.floor(i.inOut(r(s,.02,.92))*P/2)*2);let b=r(v,.45,.6)*(1-r(v,.85,.98));se.opacity=Math.max(r(s,0,.1)*(1-r(d,.1,.6)*.85)*(1-m),b*.8),se.color.set(v>.4?14084341:11916520);let x=i.inOut(r(c,.05,.75));F.scale.set(1,Math.max(.001,x),1),fe.opacity=r(c,0,.15)*(1-r(u,.1,.5)*.45)*(1-r(d,.1,.8)*.8)*(1-r(f,.2,.7))*.95,he.position.y=t(.05,Wu*Gu-.05,r(c,.4,.95))/Math.max(.001,x),me.opacity=r(c,.35,.5)*(1-r(c,.92,1))*.12,he.visible=ge.visible=me.opacity>.001,ge.position.y=he.position.y,C.lid.opacity=1-r(u,.02,.18)*(1-r(u,.86,1)),C.lid.transparent=C.lid.opacity<.999,ee.visible=C.lid.opacity>.001,j.visible=u>.01;for(let e=0;e<ve;e++){let n=i.outBack(r(u,.2+e/ve*.25,.38+e/ve*.25));dd(ye,e,_e[e][0],t(-6,-1.5,n),_e[e][1],1,+(u>.2),1)}ye.instanceMatrix.needsUpdate=!0;let S=i.out(r(u,.55,.86));be.position.y=t(-3.2,.05,S),be.visible=u>.55,Te.opacity=Math.sin(Math.PI*r(u,.15,1))*.55+Math.sin(Math.PI*r(d,0,.5))*.15;let w=i.inOut(r(u,.1,.6))*(1-i.inOut(r(m,.05,.45)));R.visible=w>.005,R.scale.set(1,Math.max(.001,w),1);let{slew:T,trolley:D,cable:O,hook:k,load:A}=R.userData,te=Math.min(4,Math.floor(d*Wu)),N=-.55+d*1.3+Math.sin(d*Wu*Math.PI)*.22+f*.9;T.rotation.y=N;let ne=22+Math.sin(d*Wu*Math.PI*2)*6+f*4;D.position.x=ne;let re=-t(td-(te+1)*Gu-2.5,6,r(f,.3,1))+Math.sin(d*30)*.8;O.scale.y=-re,k.position.y=re-.4,A.visible=d>.02&&d<.98,A.rotation.y=-N*.6;for(let e=0;e<Wu;e++){let t=e/Wu,n=r(d,t*.92,t*.92+.3);for(let t=0;t<ve;t++){let a=3.2800000000000002*i.inOut(r(n,t/ve*.25,t/ve*.25+.2));dd(Oe,e*ve+t,_e[t][0],e*Gu+.3+a/2,_e[t][1],1,a,1)}}Oe.instanceMatrix.needsUpdate=!0,ke.forEach((e,t)=>{let n=(e.f-1)/Wu,a=r(d,n*.92+.08,n*.92+.34),o=i.out(r(a,e.k/24*.5,e.k/24*.5+.5)),s=e.f*Gu-.1,c=e.k%2?1:-1,l=(1-o)*26,u=(1-o)*7;e.dir===`x`?dd(Ae,t,e.x+c*l,s+u,e.z,o>0?e.len:0,1,1):dd(Ae,t,e.x,s+u,e.z+c*l,o>0?e.len:0,1,1,Math.PI/2)}),Ae.instanceMatrix.needsUpdate=!0,je.forEach((e,t)=>{let n=t/Wu,a=i.inOut(r(d,n*.92+.2,n*.92+.36));e.visible=a>.001,e.scale.x=Math.max(.001,a),e.position.set(-12.4,(t+1)*Gu+.14,0)});let ie=i.inOut(r(d,0,.95));Me.visible=d>.001,Me.scale.y=Math.max(.001,ie),Me.position.y=.3,B.forEach((e,t)=>{let n=i.out(r(f,e.ord/Pe*.55,e.ord/Pe*.55+.14)),a=(1-n)*3.2,o=e.f*Gu+.3+.55;dd(V,t,e.x+e.n[0]*a,o-(1-n)*1.5,e.z+e.n[1]*a,n>0?e.w-.08:0,1.1,1,e.ry)}),V.instanceMatrix.needsUpdate=!0;let ae=(e,t)=>{t.forEach((t,n)=>{let a=i.inOut(r(f,.2+t.ord/Pe*.55,.2+t.ord/Pe*.55+.14)),o=t.f===0?3.05:2.05,s=t.f*Gu+.3+(t.f===0?.05:1.1)+o/2+(1-a)*2.2;dd(e,n,t.x-t.n[0]*.08,s,t.z-t.n[1]*.08,t.w-.3,a>.002?o*a:0,1,t.ry)}),e.instanceMatrix.needsUpdate=!0};ae(Re,Ie),ae(ze,Le),Be.forEach((e,t)=>{let n=18.1*i.out(r(f,.45+t/Be.length*.35,.6+t/Be.length*.35));dd(Ve,t,e.x,.3+n/2,e.z,1,n,1,e.ry)}),Ve.instanceMatrix.needsUpdate=!0;let ce=i.out(r(f,.78,1));He.visible=ce>.001,He.position.y=(1-ce)*4,He.scale.setScalar(Math.max(.001,.9+ce*.1)),C.concrete.color.set(12236459).lerp(jt.set(13617856),f);let I=i.inOut(r(m,0,.8));E.uniforms.uDay.value=I,jt.copy(kt).lerp(At,I),h.color.copy(jt),h.near=t(90,120,I),h.far=t(320,420,I),C.ground.color.copy(Mt).lerp(Nt,I),C.lid.color.copy(C.ground.color),C.plaza.opacity=i.out(r(m,.15,.55)),C.plaza.transparent=C.plaza.opacity<.999,Ke.visible=C.plaza.opacity>.001,C.asphalt.opacity=i.out(r(m,.1,.5)),C.asphalt.transparent=C.asphalt.opacity<.999,C.marking.opacity=C.asphalt.opacity,qe.visible=Je.visible=C.asphalt.opacity>.001,g.intensity=t(.35,.9,I),g.color.set(10467016).lerp(jt.set(13621472),I),g.groundColor.set(1710616).lerp(jt.set(6115648),I),_.intensity=t(.9,3.1,I),_.color.copy(Pt).lerp(Ft,I),_.position.set(t(40,70,I),t(60,20,I),t(30,-40,I)),l.toneMappingExposure=t(.95,1.02,I),C.glassLit.emissiveIntensity=i.inOut(r(m,.35,.9))*.55,C.lampHead.emissiveIntensity=i.inOut(r(m,.4,.9))*3,Ze.forEach((e,t)=>{let n=i.outBack(r(m,.1+t/Ze.length*.5,.3+t/Ze.length*.5));dd(et,t,e.x,0,e.z,e.s*n,e.h*.45*n,e.s*n),dd(tt,t,e.x,e.h*.62*n,e.z,1.7*e.s*n*(e.birch?.8:1),e.h*.42*n,1.7*e.s*n*(e.birch?.8:1))}),et.instanceMatrix.needsUpdate=tt.instanceMatrix.needsUpdate=!0,at.forEach((e,t)=>{let n=i.out(r(m,.2+t*.02,.4+t*.02));dd(ot,t,e.x,0,e.z,1,n,1),dd(st,t,e.x+.35,5*n,e.z,n,1,1)}),ot.instanceMatrix.needsUpdate=st.instanceMatrix.needsUpdate=!0,U.visible=m>.5;let le=i.inOut(r(v,.22,.5)),ue=i.inOut(r(v,.5,.68)),de=i.inOut(r(v,.82,1));dt.uniforms.uOpacity.value=le,ft.visible=le>.001,dt.uniforms.uColor.value.set(16053231).lerp(jt.set(1058875),ue).lerp(jt.set(1448733),de),dt.uniforms.uGrid.value.set(725267).lerp(jt.set(10274790),ue),dt.uniforms.uGridAmt.value=r(v,.4,.6)*(1-de),pt.uniforms.uSweep.value=i.inOut(r(v,.1,.42)),pt.uniforms.uOpacity.value=r(v,.08,.14)*(1-i.inOut(r(v,.8,.96))),pt.uniforms.uColor.value.set(1909799).lerp(jt.set(14478326),ue),mt&&(mt.visible=pt.uniforms.uOpacity.value>.001),Et=r(v,0,.12);let pe=_t(o);gt.getPoint(pe,J),W.getPoint(pe,Ot),p.fov=t(34,62,i.in(r(v,.7,1))),p.updateProjectionMatrix()}function Lt(){It(.8),w.updateMatrixWorld(!0);let e=[],t=(t,n,r=20)=>{let i=new zi(t,r);i.applyMatrix4(n);let a=i.attributes.position.array;for(let t=0;t<a.length;t++)e.push(a[t]);i.dispose()};for(let e of T)t(e.geometry,e.matrixWorld);let n=[Oe,V,Re,ze,Ve,et,Ge,ot],r=new Y;for(let t of n){let n=new zi(t.geometry,t===tt?28:20),i=n.attributes.position.array,a=new K;for(let n=0;n<t.count;n++)if(t.getMatrixAt(n,r),r.elements[0]!==0||r.elements[5]!==0){r.premultiply(t.parent.matrixWorld);for(let t=0;t<i.length;t+=3)a.set(i[t],i[t+1],i[t+2]).applyMatrix4(r),e.push(a.x,a.y,a.z)}n.dispose()}Ze.forEach(t=>{let n=t.x,r=t.z,i=t.h*.62,a=1.7*t.s*(t.birch?.8:1)*1.2,o=t.h*.42*1.2;for(let t=0;t<18;t++){let s=t/18*Math.PI*2,c=(t+1)/18*Math.PI*2;e.push(n+Math.cos(s)*a,i+Math.sin(s)*o,r,n+Math.cos(c)*a,i+Math.sin(c)*o,r),e.push(n,i+Math.sin(s)*o,r+Math.cos(s)*a,n,i+Math.sin(c)*o,r+Math.cos(c)*a),e.push(n+Math.cos(s)*a,i,r+Math.sin(s)*a,n+Math.cos(c)*a,i,r+Math.sin(c)*a)}});for(let[t,n,r,i]of[[-130,19,130,19],[-130,27,130,27],[-22,-13,22,-13],[22,-13,22,17],[22,17,-22,17],[-22,17,-22,-13]])e.push(t,.05,n,r,.05,i);let i=new br;i.setAttribute(`position`,new cr(e,3)),mt=new vi(i,pt),mt.frustumCulled=!1,mt.renderOrder=999,mt.visible=!1,f.add(mt),wt=-1}function Rt(t){let n=1-Et;if(Tt+=t*n,Te.opacity>.01){for(let e=0;e<xe;e++){let t=e*3;we[t]=Ce[t]+Math.sin(Tt*.3+e)*.8,we[t+1]=(Ce[t+1]+Tt*(.25+e%7*.04))%8,we[t+2]=Ce[t+2]+Math.cos(Tt*.25+e*1.3)*.8}Se.attributes.position.needsUpdate=!0,Ee.visible=!0}else Ee.visible=!1;if(U.visible){let t=i.out(r(e(q,a.result),.5,.9));H.forEach((e,n)=>{let r=e.x+e.v*Tt*.6;r=((r+26)%52+52)%52-26;let i=Math.abs(Math.sin(Tt*5*Math.abs(e.v)+e.d*6))*.04*Math.min(1,Math.abs(e.v)),a=e.s*t;dd(U,n,r,.8*a+i,e.z,a,a,a)}),U.instanceMatrix.needsUpdate=!0}}function zt(){let e=o.getBoundingClientRect();xt=Math.max(1,Math.round(e.width)),St=Math.max(1,Math.round(e.height)),l.setSize(xt,St,!1),p.aspect=xt/St,p.zoom=p.aspect<.8?.6:p.aspect<1.2?.8:1,p.aspect<.8?p.setViewOffset(xt,St,0,St*.14,xt,St):p.clearViewOffset(),p.updateProjectionMatrix();let t=l.getDrawingBufferSize(new G);dt.uniforms.uRes.value.copy(t),pt.uniforms.uRes.value.copy(t),wt=-1}function Bt(e){e.innerHTML=``,yt=vt.map(t=>{let n=document.createElement(`div`);return n.className=`plabel`,n.innerHTML=t.text,e.appendChild(n),n})}function Vt(){vt.forEach((e,t)=>{let n=yt[t];if(!n)return;let[i,a]=e.win,o=Math.min(r(q,i,i+.015),1-r(q,a-.015,a));if(o<=.001){n.style.opacity!==`0`&&(n.style.opacity=`0`);return}if(bt.set(e.p[0],e.p[1],e.p[2]).project(p),bt.z>1){n.style.opacity=`0`;return}let s=(bt.x*.5+.5)*xt,c=(-bt.y*.5+.5)*St,l=s<xt*.4&&c>St*.56,u=s>xt*.76&&(c<St*.3||c>St*.62);n.style.opacity=String(l||u?o*.12:o),n.style.transform=`translate3d(${s.toFixed(1)}px, ${c.toFixed(1)}px, 0)`})}let Ht=!1,Ut=0,Wt=performance.now(),Gt=0,Kt=0;function qt(e){if(!Ht)return;Ut=requestAnimationFrame(qt);let t=Math.min(.05,(e-Wt)/1e3);Wt=e;let n=c?1:1-9e-4**t;q+=(Ct-q)*n,Math.abs(Ct-q)<2e-5&&(q=Ct),Math.abs(q-wt)>1e-5&&(It(q),wt=q),Rt(t),Dt.sx+=(Dt.x-Dt.sx)*.04,Dt.sy+=(Dt.y-Dt.sy)*.04;let r=(1-Et)*!c;p.position.set(J.x+Dt.sx*1.4*r,J.y+Dt.sy*.8*r,J.z),p.lookAt(Ot),_.target.position.set(0,0,0),Vt(),l.render(f,p),t>.024?Gt++:t<.014&&Kt++,Gt>40&&d>1?(d=Math.max(1,d-.25),l.setPixelRatio(d),zt(),Gt=Kt=0):Kt>240&&d<Math.min(window.devicePixelRatio||1,u)&&(d=Math.min(u,d+.25),l.setPixelRatio(d),zt(),Gt=Kt=0)}return zt(),Lt(),It(0),{setProgress(e){Ct=n(e)},jump(e){Ct=q=n(e)},setPointer(e,t){Dt.x=e,Dt.y=t},setLabels:Bt,resize:zt,start(){Ht||(Ht=!0,Wt=performance.now(),Ut=requestAnimationFrame(qt))},stop(){Ht=!1,cancelAnimationFrame(Ut)},get progress(){return q},dispose(){this.stop(),l.dispose()}}}export{pd as createProcessScene};